...
<body>
<%
Student_marks student_marks=(Student_marks)request.getAttribute("studentmarks");
%>
    <div id="main-div">
	<form action="./updatemarks" method="post" id="myform">
		<table >
                    ...
                    <tr>
                        <th class="head" colspan="2">
                            <div id="logo-div">
                                ...
                                <div id="logo-div-two">	UPDATE MARKS</div>
                            </div>
                        </th>
                    </tr>
			...
			<tr>
				...
				<td>
					<input id="rollno" class="text" type="number" name="rollno" placeholder="Rollno" value="<%=student_marks.getROLLNO()%>" readonly><br>
			...
			<tr>
				...
				<td>
					<input id="telugu" class="text" type="number" name="telugu" placeholder="00" value="<%=student_marks.getTELUGU()%>"><br>
			...
			<tr>
				...
				<td>
					<input id="english"  class="text" type="number" name="english" placeholder="00" value="<%=student_marks.getENGLISH()%>"><br>
			...
			<td><input id="hindi" class="text" type="number" name="hindi" placeholder="00" value="<%=student_marks.getHINDI() %>"><br>
			...
			<tr>
				...
				<td>
					 <input id="maths" class="text" type="number"  name="maths" placeholder="00" value="<%=student_marks.getMATHS() %>" ><br>
<span id="error-maths"></span>
			...
			<tr>
				...
				<td>
					<input id="science" class="text" type="number" name="science" placeholder="00"  value="<%=student_marks.getSCIENCE() %>"><br>
			...
			<tr>
				...
				<td>
					<input id="social" class="text" type="number" name="social" placeholder="00" value="<%=student_marks.getSOCIAL()%>"><br>
        ...
        function validatetelugu() {
            ...
            if (Inputtelugu.value.trim().length<1 || Inputtelugu.value.trim().length>4) {
        ...
        function validateenglish() {
            ...
            if (Inputenglish.value.trim().length<1 || Inputenglish.value.trim().length>4) {
        ...
        function validatehindi() {
            ...
            if (Inputhindi.value.trim().length<1 || Inputhindi.value.trim().length>4) {
        ...
        function validatemaths() {
            ...
            if (Inputmaths.value.trim().length<1 || Inputmaths.value.trim().length>4){
        ...
        function validatescience() {
            ...
            if (Inputscience.value.trim().length<1 || Inputscience.value.trim().length>4){
        ...
        function validatesocial() {
            ...
            if( Inputsocial.value.trim().length<1 || Inputsocial.value.trim().length>4) {
