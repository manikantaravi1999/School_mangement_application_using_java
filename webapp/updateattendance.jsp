...
<body>
<%
Student_attendance student_attendance=(Student_attendance)request.getAttribute("studentattendance");
%>
    <div id="main-div">
        <form action="./Updateattendance" method="post" id="myform">
            <table>
                    ...
                    <tr>
                        <th class="head" colspan="2">
                            <div id="logo-div">
                                ...
                                <div id="logo-div-two">	UPDATE ATTENDANCE</div>
                            </div>
                        </th>
                    </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input id="rollno" class="text" type="number" name="rollno" placeholder="Rollno" value="<%=student_attendance.getROLLNO()%>" readonly><br>
                ...
                <tr>
                    ...
                    <td>
                        <input id="june" class="text" type="number" name="jun" placeholder="00" value="<%=student_attendance.getJune() %>"><br>
                ...
                <tr>
                    ...
                    <td>
                        <input id="july" class="text" type="number" name="jul" placeholder="00" value="<%=student_attendance.getJuly() %>"><br>
                ...
                <td><input id="august" class="text" type="number" name="aug" placeholder="00" value="<%=student_attendance.getAug() %>"><br>
                ...
                <tr>
                    ...
                    <td>
                         <input id="september" class="text" type="number"  name="sep" placeholder="00" value="<%=student_attendance.getSep()%>"><br>
                ...
                <tr>
                    ...
                    <td>
                        <input id="october" class="text" type="number" name="oct" placeholder="00"  value="<%=student_attendance.getOct() %>"><br>
                ...
                <tr>
                    ...
                    <td>
                        <input id="november" class="text" type="number" name="nov" placeholder="00" value="<%=student_attendance.getNov() %>"><br>
                ...
                <tr>
                    ...
                    <td>
                        <input id="december" class="text" type="number" name="dec" placeholder="00" value="<%=student_attendance.getDec() %>"><br>
                ...
                <tr>
                    ...
                    <td>
                        <input id="january" class="text" type="number" name="jan" placeholder="00" value="<%=student_attendance.getJan() %>"><br>
                ...
                <tr>
                    ...
                    <td>
                        <input id="february" class="text" type="number" name="feb" placeholder="00" value="<%=student_attendance.getFeb() %>"><br>
                ...
                <tr>
                    ...
                    <td>
                        <input id="march" class="text" type="number" name="mar" placeholder="00" value="<%=student_attendance.getMar() %>"><br>
                ...
                <tr>
                    ...
                    <td>
                        <input id="april" class="text" type="number" name="apr" placeholder="00" value="<%=student_attendance.getApr() %>"><br>
        ...
        function validatejune() {
            ...
            if (Inputjune.value.trim().length<1 || Inputjune.value.trim().length>4) {
        ...
        function validatejuly() {
            ...
            if (Inputjuly.value.trim().length<1 || Inputjuly.value.trim().length>4) {
        ...
        function validateaugust() {
            ...
            if (Inputaugust.value.trim().length<1 || Inputaugust.value.trim().length>4) {
        ...
        function validateseptember() {
            ...
            if (Inputseptember.value.trim().length<1 || Inputseptember.value.trim().length>4) {
        ...
        function validateoctober() {
            ...
            if (Inputoctober.value.trim().length<1 || Inputoctober.value.trim().length>4) {
            ...
            if (Inputnovember.value.trim().length<1 || Inputnovember.value.trim().length>4){
        ...
        function validatedecember() {
            ...
            if (Inputdecember.value.trim().length<1 || Inputdecember.value.trim().length>4){
        ...
        function validatejanuary() {
            ...
            if (Inputjanuary.value.trim().length<1 || Inputjanuary.value.trim().length>4 ){
        ...
        function validatefebruary() {
            ...
            if (Inputfebruary.value.trim().length<1 || Inputfebruary.value.trim().length>4) {
        ...
        function validatemarch() {
            ...
            if( Inputmarch.value.trim().length<1 || Inputmarch.value.trim().length>4) {
        ...
        function validateapril() {
            ...
            if (Inputapril.value.trim().length<1 || Inputapril.value.trim().length>4) {
