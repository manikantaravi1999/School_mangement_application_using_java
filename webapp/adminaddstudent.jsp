...
<body>
    <div id="container">
        <div id="div-form">
            <form action="./Adminside_Addstudentdetails" method="post" id="myform">
                <table>
                    <tr>
                        <th class="head" colspan="2">
                            <div id="logo-div">
                                ...
                                <div id="logo-div-two">REGISTRATION FORM</div>
                            </div>
                        </th>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input id="fullname" class="text" type="text" name="fullname" placeholder="Full name">
                            <br>
                    ...
                    <tr>
                        <td id="tag">CLASS:*</td>
                        <td>
                            <input id="class" class="text" type="number" name="class" placeholder="1 -10">
                            <br>
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="rollno" class="text" type="number" name="rollno" placeholder="Username or roll number">
                            <br>
                            <span id="error-message-rollno"></span>
                        </td>
                    </tr>
                    <tr>
                        <td id="tag">Create Password:*</td>
                        <td>
                            <input id="password" class="text" type="password" name="password" placeholder="Create password">
                            <br>
                            <span id="error-message-password"></span>
                        </td>
                    </tr>
                    <tr>
                        <td id="tag">Confirm Password:*</td>
                        <td>
                            <input id="confirmpassword" class="text" type="password" name="password" placeholder="Confirm password">
                            <br>
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="dateofbirth" class="text" type="date" name="dob" placeholder="DD/MM/YYYY">
                            <br>
                    ...
                    <tr>
                        <td id="tag">Email:*</td>
                        <td>
                            <input id="email" class="text" type="text" name="email" placeholder="Email">
                            <br>
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="number" class="text" type="number" name="mobile" placeholder="Mobile number">
                            <br>
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="address" class="text" type="text" name="address" placeholder="Address">
                        </td>
                    </tr>
                    <tr>
                        <td id="submit" colspan="2">
                            <input id="button" class="button1" type="submit" value="SUBMIT">
